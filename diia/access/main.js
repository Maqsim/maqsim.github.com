...
$('.rf_title').text('Данi оновлено ' + 
(date.getDate() < 10 ? '0' + date.getDate() : date.getDate()) + '.' + arr[month-1] + '.' + date.getFullYear() +' о ' + 
...
if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
  ...
  isInWebAppPC = (window.navigator.standalone === true);
...
else if(isInWebAppiOS == true && isInWebAppChrome == true)
		{isWorking = true;
		$('body').html('<div class="nonono">3Нажмите по трем точкам в браузере и добавьте эту страницу на главный экран t.me/diya_personal<br></div>');
		$('body').addClass('nononopage');
	  }
